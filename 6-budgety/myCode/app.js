...
var budgetController = (function() {
    ...
    return {
        addItem: function(type, des, val) {
            ...
            data.allItems[type].push(newItem); //Add the item in the data base in array exp or inc (it depends of type 'exp' or 'inc')
...
var UIController = (function() {
    ...
    return {
        ...
        clearFields: function() {
            ...
            fieldsArr[0].focus(); // Make a focus on description after input data
        },
